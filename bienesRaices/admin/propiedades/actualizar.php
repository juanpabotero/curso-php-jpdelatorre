...
// obtener un registro de la consulta, devuelve un arreglo asociativo
// mysqli_fetch_assoc('resultado de la consulta')
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errores)) {
        ...
        if ($imagen['name']) {
            ...
            // Subir la imagen
            // move_uploaded_file(ubicacion temporal, ubicacion destino, nombre imagen)
...
<main class="contenedor seccion">
    ...
    Si no se pone, por defecto lo envia al mismo archivo -->
    <!-- enctype="multipart/form-data" la forma de encriptar los datos para enviar,
    normalmente se usa cuando tienes subida de archivos  -->
